...
#leave blank line and also remove white space
...
def logout():
    ...
    session.clear()
    # or session.pop("user") > must specify which session cookie you want to delete
    return redirect(url_for("login"))
...
def add_task():
    if request.method == "POST":
        ...
        task = {
            ...
            #use .getlist() for things that can be an array of items
